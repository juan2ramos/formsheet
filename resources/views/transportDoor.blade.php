    ...
    <section class="container form-ruta-empresarial">
        ...
        <div class="row align-center justify-around descrip-service">
            ...
            <div class="col-16 col-m-10 col-l-10">
                ...
                <p>Servicio disponible únicamente entre Bogotá y Villavicencio. Te recogemos en tu casa y te llevamos
                    hasta donde necesites.</p>
            </div>
        </div>
        ...
        <form action="" method="post" id="DoorForm">
            {{ csrf_field() }}
            <div class="row justify-center item">
                ...
                <div class="col-16 col-m-7 col-l-7 m-t-8">
                    <input id="cityBogota" class="rectangle" type="radio" checked name="origin" value="BOGOTA">
            ...
            <div class="row justify-evenly item">
                ...
                <div class="row justify-center">
                    <button type="button" name="button" id="availability" class="solCot">VER DISPONIBILIDAD</button>
                </div>
            </div>
