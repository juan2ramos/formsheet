...
<section class="container form-ruta-empresarial">
	...
	<form id="formPrincipal" action="{{route('calculate')}}" method="post">
		...
		<div class="row justify-center item">
			...
			<div class="col-16 col-m-4 col-l-4 m-t-8">
				<input id="" class="" type="text" name="destiny" value="">
			</div>
		</div>
		<!--div>
		...
		<div class="row justify-center item">
			...
			<div class="col-16 span">
				<span>*Precio estimado, puede variar dependiendo dirección y horario.</span>
			</div>
			<div class="row justify-center">
		...
		<div class="row justify-center">
			<button type="submit" name="button" class="solCot">RESERVAR</button>
		</div>
