			...
			<div class="row justify-between item">
				...
				<div class="col-10 m-t-8">
					...
					<label for="i-v-d-d" class="moreInfo" data-content="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis dignissim, massa sed efficitur
						mattis,dos">Ida y vuelta en días diferentes <span><img src="{{asset('images/iconincog.png')}}" alt=""></span> </label>

					<input type="radio" id="i-v-s-d" class="circle tipo-viaje" name="travel" value="3" placeholder="">
					<label for="i-v-s-d" class="moreInfo" data-content="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis dignissim, massa sed efficitur
						mattis,tres" >Ida y vuelta sin disponibilidad <span><img src="{{asset('images/iconincog.png')}}" alt=""></span> </label>

					<input type="radio" id="i-v-c-d" class="circle tipo-viaje" name="travel" value="4" placeholder="">
					<label for="i-v-c-d" class="moreInfo" data-content="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis dignissim, massa sed efficitur
						mattis,cuatro" >Ida y vuelta con disponibilidad <span><img src="{{asset('images/iconincog.png')}}" alt=""></span> </label>
