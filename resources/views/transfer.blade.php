        ...
        <form action="" method="post" id="transferForm">
            ...
            <div class="row justify-between item">
                ...
                <div class="col-16 m-t-8 m-a">
                    ...
                    <input type="radio" id="recorrido" class="circle tipo-viaje" name="typeTransfer" value="1"
                           placeholder="">
                    <label for="recorrido" class="moreInfo"
                           data-content="Máximo 1 hora y 30 Km dentro del perimetro urbano.">1 recorrido <span><img
                    ...
                    <input type="radio" id="airport" class="circle tipo-viaje" name="typeTransfer" value="2"
                           placeholder="">
                    <label for="airport" class="moreInfo"
                           data-content="Te llevamos o te recogemos hacia o desde el aeropuerto.">Aeropuerto <span><img
                                    src="{{asset('images/iconincog.png')}}" alt=""></span></label>

                    <input type="radio" id="i-v" class="circle tipo-viaje" name="typeTransfer" value="3" placeholder="">
                    <label for="i-v" class="moreInfo"
                           data-content="Máximo 2 horas de recorrido. 3 horas de espera. Hasta 50 kilometros.">Ida y
                        vuelta <span><img src="{{asset('images/iconincog.png')}}" alt=""></span></label>

                    <input type="radio" id="d-d" class="circle tipo-viaje" name="typeTransfer" value="4" placeholder="">
                    <label for="d-d" class="moreInfo" data-content="8 horas. Hasta 100 km.">Disponibilidad día.
                        <span><img src="{{asset('images/iconincog.png')}}" alt=""></span></label>

                </div>

                <div class="col-10 m-t-8 m-a">
                    <div class="infoBox infoBoxTransfer m-t-24 hidden" id="infoBox"></div>
                </div>
            </div>
            ...
            <div class="row justify-evenly">
                ...
                <div class="col-6 datos-personales">
                    <input type="email" class="datos-personalesEmail m-t-8" id="email" name="email" value=""
